 ...
 */
public class Frame4InfoSholawat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Salam.setText("Istiqomah Bersholawat");

        jLabel1.setText("Sebelum itu, kita lihat dulu yuk faedah-faedah dari ");

        jLabel2.setText("Banyak bersholawat!");
        ...
        jLabel4.setText("Satu sholawat membawa satu malaikat");

        jLabel5.setText("Hadits 2 - kelipatan niat baik");

        jLabel6.setText("Membawa perubahan yang besar dalam hidup");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame4InfoSholawat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frame4InfoSholawat().setVisible(true);
            }
        });
    }
